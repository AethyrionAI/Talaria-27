...
- **🚨 THE DEVICE HAS MOVED PAST THE TOOLCHAIN (measured 2026-08-22, #398).**
  ...
  **⟵ MEASURED since (this file lagged CLAUDE.md on all three): 2026-08-27 the device
  read `24A5424a` (#416's runs); 2026-09-06 it read `24A5430a` (#392/#398's device
  runs — on the phone since 08-31/09-01); and on 2026-09-09/10 (#441) the Xcode 27 RC
  (27A266a) arrived with iOS SDK `24A430` and sim runtime `24A434` — the first Xcode
  whose runtime and SDK are different builds — while Owen installed the iOS 27 RC on
...
- **THE CLOSE-OUT RULE (2026-08-06, from the reconciliation audit; RATIFIED by
  ...
  doc, and AGENTS.md line whose text its result FALSIFIES is corrected in the same
  ...
  OWN docs — a tracker entry, a AGENTS.md line — never an external repository;

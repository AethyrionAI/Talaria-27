...
- **#422** 🧠 **MEMORY–AGENT INTEGRATION — REOPENED 09-02 for DESIGN** (was parked post-launch 08-31): four rulings — retrieval + explicit notes only (nothing inferred) · Memory screen with source + per-reply provenance chip · local and host stores NEVER merged · design now, pre/post-launch decided after the Fable design doc. Lane in flight

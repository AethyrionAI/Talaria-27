# FROZEN REFERENCE SNAPSHOT (2026-07-20) of the Claude<->Hermes Sessions-API MCP bridge.
# Canonical/living copy: ~/Documents/Claude/HermesMCP (dev tool, outside this repo).
# In-repo so Fable can read a working Sessions-API MCP client during #150 design work.
# Do NOT edit here; do NOT wire into any build.

...
enum PermissionType: String, Codable, CaseIterable, Identifiable, Hashable, Sendable {
    ...
    var explanation: String {
        switch self {
        case .location:
            "Talaria uses your location to provide contextual recommendations, weather updates, and nearby suggestions."
        case .health:
            "Access your health data to offer personalized wellness insights, activity tracking, and sleep recommendations."
        case .microphone:
            "Voice conversations with Talaria in Talk Mode."
        case .camera:
            "Capture photos and documents for Talaria to analyze, annotate, or organize."
        case .photos:
            "Access your photo library to help organize, search, and create albums based on your preferences."
        case .motion:
            "Talaria uses motion data to understand your current activity for contextual awareness."
        case .speechRecognition:

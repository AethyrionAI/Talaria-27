...
- The iOS app requires Xcode with the **iOS 27 SDK** (Xcode 27 RC — `Xcode-rc.app`, 27A266a, as of 2026-09-10; `Xcode-beta6.app` is the A/B fallback)
...
```bash
# Requires Xcode 27 (iOS 27 SDK) — the RC as of 2026-09-10.
...
# Point at the iOS 27 toolchain first, or iOS 27 APIs fail to resolve:

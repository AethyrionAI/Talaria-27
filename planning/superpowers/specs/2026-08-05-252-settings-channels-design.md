...
| 02 | SERVER | Hero: stacked profile-bar motif, status `<ACTIVE PROFILE> · ACTIVE` / `NO PROFILE CONFIGURED`, chip `BACKEND PROFILES`. Content: inventory §3 in full (profile cards + menus, provisioning message, Add Profile, ~~Auto-connect toggle~~ — **deleted 2026-08-31, #420: inert control, zero readers**, alerts, editor sheet). |

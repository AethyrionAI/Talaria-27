...
"Hey Siri, ask Talaria twenty-seven" (the registered phrase is "Ask Talaria27" — `.applicationName` resolves to CFBundleDisplayName; "Ask Hermes" routes to contacts, "Ask Talaria" to mythology facts) and also add the action in the Shortcuts app.
